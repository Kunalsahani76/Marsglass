...
import imgSpiderGlazing3 from "./8bd0ab72582237bb6f6eb140b6053fcc54138ff0.png";
import imgSpiderGlazing4 from "./d9d7abd61c0900076bd466d8aaadc13901df55d7.png";
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0a2540] text-[20px] w-full">
        <p className="leading-[28px]">Sliding Windows</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-full">
        <p className="leading-[22.75px]">Space-saving horizontal sliding</p>
      </div>
    </div>
  );
}
...
function Heading1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0a2540] text-[20px] w-full">
        <p className="leading-[28px]">Casement Windows</p>
      </div>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-full">
        <p className="leading-[22.75px]">Outward opening hinged windows</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0a2540] text-[20px] w-full">
        <p className="leading-[28px]">Fixed Windows</p>
      </div>
    </div>
  );
}
...
function Container8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-full">
        <p className="leading-[22.75px]">Non-opening, max natural light</p>
      </div>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-full">
        <p className="leading-[22.75px]">No frequent repair needed</p>
      </div>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Heading 3">
      <div className="flex flex-col font-['Poppins:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#0a2540] text-[20px] w-full">
        <p className="leading-[28px]">High Durability</p>
      </div>
    </div>
  );
}
...
function Container14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-full">
        <p className="leading-[22.75px]">{`Rust & weather resistant`}</p>
      </div>
    </div>
  );
}
...
function Container17() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#475569] text-[14px] w-full">
        <p className="leading-[22.75px]">Clean and sleek design</p>
      </div>
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="aluminum-windows-spec-header bg-[#111828] relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
...
function Frame16() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-0 px-[20px] py-[10px] top-[12px] w-[741px]">
      ...
      <div className="flex flex-col font-['Roboto:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[18px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">1.2 – 2.2 mm</p>
      </div>
    </div>
  );
}
...
function Frame17() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-0 px-[20px] py-[10px] top-[12px] w-[741px]">
      ...
      <div className="flex flex-col font-['Roboto:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[18px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">Powder Coating / Anodized</p>
      </div>
    </div>
  );
}
...
function Frame19() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-0 px-[20px] py-[10px] top-[12px] w-[741px]">
      ...
      <div className="flex flex-col font-['Roboto:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[18px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">5 – 24 mm</p>
      </div>
    </div>
  );
}
...
function Frame21() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-0 px-[20px] py-[10px] top-[12px] w-[741px]">
      ...
      <div className="flex flex-col font-['Roboto:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[18px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">EPDM Gaskets</p>
      </div>
    </div>
  );
}
...
function Frame22() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-between left-0 px-[20px] py-[10px] top-[12px] w-[741px]">
      <div aria-hidden="true" className="absolute border-[0.4px] border-black border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Roboto:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[18px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">Lifespan</p>
      </div>
      <div className="flex flex-col font-['Roboto:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[18px] text-black text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function Frame33() {
  return (
    <div className="aluminum-windows-spec-body content-stretch flex flex-col items-start relative shrink-0 w-[741px]">
...
function Frame24() {
  return (
    <div className="aluminum-windows-spec-section relative shrink-0 w-full">
      <div className="flex flex-col items-center size-full">
  ...
  return (
    <div className="absolute inset-[8.33%]" data-name="Group">
      <div className="absolute inset-[-2.25%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34.8333 34.8333">
          <g id="Group">
            <path d={svgPaths.p1353500} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="1.5" />
            <path d={svgPaths.p9c34600} fill="var(--fill-0, white)" id="Vector_2" />
            <path d={svgPaths.p14e02580} id="Vector_3" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function SolarWindowFrameLinear() {
  return (
    <div className="overflow-clip relative shrink-0 size-[40px]" data-name="solar:window-frame-linear">
      <Group />
    </div>
  );
}

function CbiGlasspanelDoorOpen() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="cbi:glasspanel-door-open">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
        <g id="cbi:glasspanel-door-open">
          <path d={svgPaths.p3939e700} fill="var(--fill-0, white)" id="Vector" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[28px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 28 20">
        <g id="Frame 1000007632">
          <path d={svgPaths.p245b940} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p32c79040} fill="var(--fill-0, white)" id="Vector_2" />
          <path d={svgPaths.p3779cf00} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.p1bb71e00} fill="var(--fill-0, white)" id="Vector_4" />
        </g>
      </svg>
    </div>
  );
...
function Frame51() {
  return (
    <div className="h-[26px] relative shrink-0 w-[27px]">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 27 26">
        <g id="Frame 1000007634">
          <path d={svgPaths.pb285300} fill="var(--fill-0, white)" id="Vector" />
          <path d={svgPaths.p2613600} fill="var(--fill-0, white)" id="Vector_2" />
          <path d={svgPaths.p21118180} fill="var(--fill-0, white)" id="Vector_3" />
          <path d={svgPaths.p35ea5d00} fill="var(--fill-0, white)" id="Vector_4" />
          <path d={svgPaths.p52f4c00} fill="var(--fill-0, white)" id="Vector_5" />
        </g>
      </svg>
    </div>
  );
...
function Frame45() {
  return (
    <div className="aluminum-windows-faq-answer content-stretch flex items-end relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-b-[0.5px] border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">Strong, lightweight, durable & modern look</p>
      </div>
    </div>
  );
}
...
function Frame46() {
  return (
    <div className="content-stretch flex items-end justify-between relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-b-[0.5px] border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Roboto:Bold',sans-serif] font-bold justify-center leading-[0] relative shrink-0 text-[18px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">Are they energy efficient?</p>
      </div>
      <Frame3 />
    </div>
  );
...
function Frame47() {
  return (
    <div className="aluminum-windows-faq-answer content-stretch flex items-end relative shrink-0 w-full">
      <div aria-hidden="true" className="absolute border-b-[0.5px] border-solid border-white inset-0 pointer-events-none" />
      <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[40px]">Yes, with double glazing & thermal break</p>
      </div>
    </div>
  );
}
...
function Frame48() {
  return (
    <div className="aluminum-windows-faq-panel bg-[#0a2540] content-stretch flex flex-col gap-[18px] items-start p-[50px] relative rounded-[12px] shrink-0 w-[777px]">
      <div className="aluminum-windows-faq-item content-stretch flex flex-col h-[44px] items-start overflow-clip relative shrink-0 w-[677px]">
        <Frame44 />
        <Frame45 />
      </div>
      <div className="aluminum-windows-faq-item content-stretch flex flex-col h-[44px] items-start overflow-clip relative shrink-0 w-[677px]">
...
export default function Service() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="service 5">
      <Frame41 />
      <ModernGlassBuilding />
      <Frame12 />
      <Frame8 />
